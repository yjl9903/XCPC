...
namespace CircleGeometry {
  ...
  int checkposCC(Circle k1, Circle k2) {
    ...
    double dis = k1.o.distance(k2.o);
    int w1 = dcmp(dis,k1.r + k2.r), w2 = dcmp(dis,k1.r - k2.r);
    if (w1 > 0) return 4;
  ...
  vector<Point> getCC(Circle k1, Circle k2) {
    ...
    double cosA = (k1.r * k1.r + a - k2.r * k2.r) / (2 * k1.r * sqrt(max(a, 0.0)));
    double b = k1.r * cosA;
    double c = sqrt(max(0.0, k1.r * k1.r - b * b));
  ...
  vector<Point> tangentCP(Circle k1, Point k2) {
    double a = (k2 - k1.o).abs();
    double b = k1.r * k1.r/a;
    double c = sqrt(max(0.0, k1.r * k1.r - b * b));
