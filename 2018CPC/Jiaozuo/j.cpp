...
int main()
{
    ...
    while(T--)
    {
        ...
        bool flag1=check(A);
        bool flag2=check(B);
        if(flag1==1&&flag2==1)printf("Arena of Valor\n");
        else if(flag1==0&&flag2==1)printf("Clash Royale\n");
        else if(flag1==0&&flag2==0)printf("League of Legends\n");
        else printf("Hearth Stone\n");
    }
    return 0;
}